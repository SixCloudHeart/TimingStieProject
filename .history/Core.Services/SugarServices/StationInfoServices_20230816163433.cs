...
namespace Core.Services.SugarServices
{
    public class StationInfoServices : BaseServices<StationInfo>, IStationInfoService
    {
        ...
        public StationInfoServices(IReadSiteSettingXML readSiteSettingXML, IStationinfoRepository stationinfoRepository, IConfiguration configuration, IRedisServices redisServices)
        {
